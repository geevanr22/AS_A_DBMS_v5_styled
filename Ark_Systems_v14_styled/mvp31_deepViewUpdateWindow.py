...
class DeepViewUpdateWindow(QWidget): # Name here has been changed to MainWindow2
    ...
    def uiSetup3(self):
        ...
        self.lineEditContactPerson.setText(self.selectedRow1[31])
        self.labelContactTel = QLabel('Contact Tel:')
        self.lineEditContactTel = QLineEdit()
        self.lineEditContactTel.setText(self.selectedRow1[32])
        self.labelContactEmail = QLabel('Contact Email')
        self.lineEditContactEmail = QLineEdit()
        self.lineEditContactEmail.setText(self.selectedRow1[33])
        ...
        self.lineEditSecretariesName_1.setText(self.selectedRow1[23])
        ...
        self.newDateEditAppointedDate_Secretary_1 = self.selectedRow1[24]
        self.setDateNewDateEditAppointedDate_Secretary_1String = QDate.fromString(self.newDateEditAppointedDate_Secretary_1, "d-MMM-yyyy")
        ...
        self.newDateEditResignedDate_Secretary_1 = self.selectedRow1[25]
        self.setDateNewDateEditResignedDate_Secretary_1String = QDate.fromString(self.newDateEditResignedDate_Secretary_1, "d-MMM-yyyy")
        ...
        self.newDateEditVacatedDate_Secretary_1 = self.selectedRow1[26]
        self.setDateNewDateEditVacatedDate_Secretary_1String = QDate.fromString(self.newDateEditVacatedDate_Secretary_1, "d-MMM-yyyy")
        ...
        self.labelSecretaries_2_Name = QLabel('Secretaries 2:')
        self.lineEditSecretariesName_2 = QLineEdit()
        self.lineEditSecretariesName_2.setText(self.selectedRow1[27])
        ...
        self.newDateEditAppointedDate_Secretary_2 = self.selectedRow1[28]
        self.setDateNewDateEditAppointedDate_Secretary_2String = QDate.fromString(self.newDateEditAppointedDate_Secretary_2, "d-MMM-yyyy")
        ...
        self.newDateEditResignedDate_Secretary_2 = self.selectedRow1[29]
        self.setDateNewDateEditResignedDate_Secretary_2String = QDate.fromString(self.newDateEditResignedDate_Secretary_2, "d-MMM-yyyy")
        ...
        self.newDateEditVacatedDate_Secretary_2 = self.selectedRow1[30]
        self.setDateNewDateEditVacatedDate_Secretary_2String = QDate.fromString(self.newDateEditVacatedDate_Secretary_2, "d-MMM-yyyy")
        ...
        self.lineEditPreparedBy.setText(self.selectedRow1[34])
        self.lineEditCheckedBy = QLineEdit()
        self.lineEditCheckedBy.setText(self.selectedRow1[36])
        self.lineEditScannedBy = QLineEdit()
        self.lineEditScannedBy.setText(self.selectedRow1[38])
        ...
        self.newDateEditPrepared = self.selectedRow1[35]
        ...
        self.newDateEditScanned = self.selectedRow1[37]
        ...
        self.newDateEditChecked = self.selectedRow1[39]
    ...
    def nextRecord(self):
        ...
        try:
            self.currentIndex = self.comboBoxDeepView.currentIndex()
            self.nextCompanyButton = (self.comboBoxList[self.currentIndex+1]) # this will give us the next company from the combobox to be selected when the "Next" button is clicked
    ...
    def comboBoxSelectionDataFieldInput(self):
        ...
        self.lineEditNatureOfBusiness.setText(self.comboBoxSelectionData[9])  # <-------------------------------------------

        self.lineEditPaidUpCapital.setText(self.comboBoxSelectionData[10])  # <-------------------------------------------
        ...
        self.lineEditContactPerson.setText(self.comboBoxSelectionData[31])
        self.lineEditContactTel.setText(self.comboBoxSelectionData[32])
        self.lineEditContactEmail.setText(self.comboBoxSelectionData[33])



        # Secretaries 1 ----------------------------------------------------------------------
        self.lineEditSecretariesName_1.setText(self.comboBoxSelectionData[23])
        ...
        self.newDateEditAppointedDate_Secretary_1 = self.comboBoxSelectionData[24] #<-------------------------------------------
        self.setDateNewDateEditAppointedDate_Secretary_1String = QDate.fromString(self.newDateEditAppointedDate_Secretary_1, "d-MMM-yyyy")
        ...
        self.newDateEditResignedDate_Secretary_1 = self.comboBoxSelectionData[25] #<-------------------------------------------
        self.setDateNewDateEditResignedDate_Secretary_1String = QDate.fromString(self.newDateEditResignedDate_Secretary_1, "d-MMM-yyyy")
        # self.dateEditResignedDate_Secretary_1 = QDateEdit()
        # self.dateEditResignedDate_Secretary_1.setDisplayFormat("d-MMM-yyyy")
        self.dateEditResignedDate_Secretary_1.setDate(self.setDateNewDateEditResignedDate_Secretary_1String)
        ...
        self.newDateEditVacatedDate_Secretary_1 = self.comboBoxSelectionData[26] #<-------------------------------------------
        self.setDateNewDateEditVacatedDate_Secretary_1String = QDate.fromString(self.newDateEditVacatedDate_Secretary_1, "d-MMM-yyyy")
        # self.dateEditVacatedDate_Secretary_1 = QDateEdit()
        # self.dateEditVacatedDate_Secretary_1.setDisplayFormat("d-MMM-yyyy")
        self.dateEditVacatedDate_Secretary_1.setDate(self.setDateNewDateEditVacatedDate_Secretary_1String)
        ...
        self.lineEditSecretariesName_2.setText(self.comboBoxSelectionData[27])

        self.newDateEditAppointedDate_Secretary_2 = self.comboBoxSelectionData[28] #<-------------------------------------------
        self.setDateNewDateEditAppointedDate_Secretary_2String = QDate.fromString(self.newDateEditAppointedDate_Secretary_2, "d-MMM-yyyy")
        self.dateEditAppointedDate_Secretary_2.setDate(self.setDateNewDateEditAppointedDate_Secretary_2String)


        self.newDateEditResignedDate_Secretary_2 = self.comboBoxSelectionData[29] #<-------------------------------------------
        self.setDateNewDateEditResignedDate_Secretary_2String = QDate.fromString(self.newDateEditResignedDate_Secretary_2, "d-MMM-yyyy")
        self.dateEditResignedDate_Secretary_2.setDate(self.setDateNewDateEditResignedDate_Secretary_2String)


        self.newDateEditVacatedDate_Secretary_2 = self.comboBoxSelectionData[30] #<-------------------------------------------
        self.setDateNewDateEditVacatedDate_Secretary_2String = QDate.fromString(self.newDateEditVacatedDate_Secretary_2, "d-MMM-yyyy")
        self.dateEditVacatedDate_Secretary_2.setDate(self.setDateNewDateEditVacatedDate_Secretary_2String)


        self.lineEditPreparedBy.setText(self.comboBoxSelectionData[34])
        self.lineEditCheckedBy.setText(self.comboBoxSelectionData[36])
        self.lineEditScannedBy.setText(self.comboBoxSelectionData[38])


        self.newDateEditPrepared = self.comboBoxSelectionData[35] #<-------------------------------------------
        self.setDateNewDateEditPreparedString = QDate.fromString(self.newDateEditPrepared, "d-MMM-yyyy")
        self.dateEditPrepared.setDate(self.setDateNewDateEditPreparedString)

        self.newDateEditScanned = self.comboBoxSelectionData[37]  # <-------------------------------------------
        self.setDateNewDateEditScannedString = QDate.fromString(self.newDateEditScanned, "d-MMM-yyyy")
        self.dateEditScanned.setDate(self.setDateNewDateEditScannedString)

        self.newDateEditChecked = self.comboBoxSelectionData[39]  # <-------------------------------------------
        self.setDateNewDateEditCheckedString = QDate.fromString(self.newDateEditChecked, "d-MMM-yyyy")
        self.dateEditChecked.setDate(self.setDateNewDateEditCheckedString)
